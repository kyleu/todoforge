...
##
## Outputs:
##   - build/dist/todoforge_<version>_darwin_*_desktop.(dmg|zip)
##   - build/dist/todoforge_<version>_linux_amd64_desktop.zip
##   - build/dist/todoforge_<version>_windows_amd64_desktop.zip
...
codesign -f --options=runtime --verbose=4 --deep --force --strict -s "${APPLE_SIGNING_IDENTITY}" "./TODO Forge.app/Contents/MacOS/todoforge"
codesign -f --options=runtime --verbose=4 --deep --force --strict -s "${APPLE_SIGNING_IDENTITY}" "./TODO Forge.app"
...
cd "$dir/../.."
echo "Builds written to ./build/dist (todoforge_${TGT}_*_desktop.*)"
