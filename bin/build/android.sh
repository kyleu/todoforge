...
##
## Outputs:
##   - build/dist/todoforge_<version>_android_aar.zip
##   - build/dist/todoforge_<version>_android_apk.zip
...
GOARCH=arm64 time gomobile bind -o build/dist/mobile_android_arm64/todoforge.aar -target=android -androidapi 21 github.com/kyleu/todoforge/app/cmd
...
echo "Output written to [./build/dist/todoforge_${TGT}_android_aar.zip] and [./build/dist/todoforge_${TGT}_android_apk.zip]"
