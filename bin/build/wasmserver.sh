...
echo "building TODO Forge WASM server library..."
GOOS=js GOARCH=wasm go build -o ./build/wasm/todoforge.wasm .
echo "Output written to ./build/wasm (todoforge.wasm and assets)"
