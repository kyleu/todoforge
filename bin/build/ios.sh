...
##
## Outputs:
##   - build/dist/todoforge_<version>_ios_framework.zip
##   - build/dist/todoforge_<version>_ios_app.zip
...
cd "$dir/../.."
echo "Output written to ./build/dist/todoforge_${TGT}_ios_framework.zip and ./build/dist/todoforge_${TGT}_ios_app.zip"
