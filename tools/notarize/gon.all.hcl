...
notarize {
  path = "./build/dist/todoforge_0.1.3_darwin_all_desktop.dmg"
  bundle_id = "dev.kyleu.todoforge"
}
...
dmg {
  output_path = "./build/dist/todoforge_0.1.3_darwin_all.dmg"
  volume_name = "TODO Forge"
}

zip {
  output_path = "./build/dist/todoforge_0.1.3_darwin_all_notarized.zip"
}
