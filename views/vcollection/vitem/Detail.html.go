...
//line views/vcollection/vitem/Detail.html:18
  ...
  <div class="card">
    <div class="right">
      <a href="#modal-item"><button type="button" title="JSON">`)
...
//line views/vcollection/vitem/Detail.html:46
		qw422016.N().S(`
            `)
//line views/vcollection/vitem/Detail.html:47
		view.StreamUUID(qw422016, &p.Model.CollectionID)
//line views/vcollection/vitem/Detail.html:47
		qw422016.N().S(`
            `)
//line views/vcollection/vitem/Detail.html:48
	}
//line views/vcollection/vitem/Detail.html:48
	qw422016.N().S(`
          </td>
...
//line views/vcollection/vitem/Detail.html:53
	qw422016.N().S(`</strong></td>
        ...
        <tr>
          ...
          <td>`)
//line views/vcollection/vitem/Detail.html:57
...
`)
//line views/vcollection/vitem/Detail.html:62
}
